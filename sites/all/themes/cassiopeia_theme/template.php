...
function cassiopeia_theme_preprocess_page(&$variables) {
	drupal_add_css(drupal_get_path('module', 'cassiopeia_adv') . '/swiper/css/swiper.min.css', ['weight' => 5]);
	drupal_add_js(drupal_get_path('module', 'cassiopeia_adv') . '/swiper/js/swiper.min.js', ['weight' => 5]);
    drupal_add_js("https://cdn.jsdelivr.net/momentjs/latest/moment.min.js", ['weight' => 1000]);
    ...
    drupal_add_js("https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.min.js", ['weight' => 1000]);
    drupal_add_css("https://cdn.jsdelivr.net/npm/daterangepicker/daterangepicker.css", ['weight' => 1000]);
    drupal_add_js("https://translate.google.com/translate_a/element.js?cb=googleTranslateElementInit");
	global $user;
	$arg = arg();
    ...
    elseif ($arg[0] == 'user') {
        ...
        elseif (count($arg) == 2) {
            ...
            }else if($arg[1] == "register" || $arg[1] == "login"){
                $variables['theme_hook_suggestions'][] = 'page__register';
            }
        }else{
            $variables['theme_hook_suggestions'][] = 'page__logined';
        }
    }
