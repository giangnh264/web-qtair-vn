    ...
    <div class="itinerary">
        ...
        <div class="search-fly-number-night">
            <div class="input-fn">
                ...
                <!--                        <input id="number_of_night" name="number_of_night" type="number" class="form-control number_of_night" value="--><?php //echo $night_count; ?><!--" placeholder="Số đêm">-->
        ...
        <div class="search-customer-quantity">
            ...
            <div class="text">
                <span class="fa-light fa-user mr-1"></span> <span class="guest-count"><?php echo $_SESSION['hotel-search']['adult']+$_SESSION['hotel-search']['children']; ?></span>&nbsp;Khách
            </div>
        ...
        <div class="search-fly-form-actions clearfix">
            <?php echo drupal_render($form['review']); ?>
                            ...
                            <div class="node-price-right">
                                <div class="quantity-room d-flex alg-center">
                                    ...
                                    <div class="inp-price d-flex quantity-change" data-min="1">
                                        ...
                                        <input aria-label="quantity" class="input-qty room-quantity" min="1" max="10" name="" type="number" value="1" data-price="<?php echo $room_price->price*$night_count; ?>" data-original-price="<?php echo $room_price->original_price*$night_count; ?>" data-night="<?php echo $night_count; ?>">
                                        <i class="fa fa-plus"></i>
                                    </div>
                                </div>
                                <?php if(!empty($room_price)&&!empty($room_price->price)&&$room_price->original_price!=$room_price->price&&$original_price>0): ?>
                                    <div class="discount">
                                        <span>-<?php echo round(((($room_price->original_price-$room_price->price)/$room_price->original_price))*100) ?>%</span>
                                        <span class="original-price"><?php echo number_format($room_price->original_price*$night_count,0,",","."); ?> VNĐ</span>
                                    </div>
                                <?php endif; ?>
                                <div class="price d-flex">
                                    <b class="mr-5">Tổng tiền:</b> <span class=""><?php echo number_format($room_price->price*$night_count,0,",","."); ?> VNĐ</span>
                                </div>
                                <div class="room-unit">
                                    /1 phòng/<?php echo $night_count; ?> đêm
                                </div>
                                <div class="">
