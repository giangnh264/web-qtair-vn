...
(function ($) {
    Drupal.behaviors.cassiopeia_room_hotel_search_form = {
        attach: function (context, settings) {
            $('.cassiopeia-room-hotel-search-form', context).once('cassiopeia-room-hotel-search-form',function () {
        ...
        detach: function(context, settings, trigger) {
            $('.cassiopeia-room-hotel-search-form', context).removeOnce('cassiopeia-room-hotel-search-form', function() {});
        }
    };
})(jQuery);