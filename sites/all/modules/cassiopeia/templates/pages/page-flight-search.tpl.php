                                        ...
                                        <div class="block-container">
                                                ...
                                                ?>
                                                 <div class="block-content">
                                                    <div class="block-body">
                                                        <?php
                                                        // Load lunar datepicker script
                                                        drupal_add_js(drupal_get_path('theme', 'cassiopeia_theme') . '/js/lib/datetimepicker/jquery.datepicker.lunar.js', ['weight' => 100]);
                                                        ?>
                                                        <div class="<?php if($search_date==date("d-m-Y",strtotime($search_date ." -3 days"))) print("active"); if(strtotime($search_date ." -3 days")< strtotime(date("dmY"))) print("inactive"); ?>" data-date="<?php print(date("d/m/Y",strtotime($search_date ." -3 days"))); ?>" data-solar-day="<?php print(date("d",strtotime($search_date ." -3 days"))); ?>" data-solar-month="<?php print(date("m",strtotime($search_date ." -3 days"))); ?>" data-solar-year="<?php print(date("Y",strtotime($search_date ." -3 days"))); ?>">
                                                            ...
                                                            <span class="lunar-date-display" style="font-size: 75%; color: #B91E1E; display: block; text-align: center;"></span>
                                                        </div >
                                                        <div class="<?php if($search_date==date("d-m-Y",strtotime($search_date ." -2 days"))) print("active"); if(strtotime($search_date ." -3 days")< strtotime(date("dmY"))) print("inactive");?>" data-date="<?php print(date("d/m/Y",strtotime($search_date ." -2 days"))); ?>" data-solar-day="<?php print(date("d",strtotime($search_date ." -2 days"))); ?>" data-solar-month="<?php print(date("m",strtotime($search_date ." -2 days"))); ?>" data-solar-year="<?php print(date("Y",strtotime($search_date ." -2 days"))); ?>">
                                                        ...
                                                        <div class="<?php if($search_date==date("d-m-Y",strtotime($search_date ." -1 days"))) print("active"); if(strtotime($search_date ." -3 days")< strtotime(date("dmY"))) print("inactive");?>" data-date="<?php print(date("d/m/Y",strtotime($search_date ." -1 days"))); ?>" data-solar-day="<?php print(date("d",strtotime($search_date ." -1 days"))); ?>" data-solar-month="<?php print(date("m",strtotime($search_date ." -1 days"))); ?>" data-solar-year="<?php print(date("Y",strtotime($search_date ." -1 days"))); ?>">
                                                        ...
                                                        <div class="<?php if($search_date==date("d-m-Y",strtotime($search_date ))) print("active");if(strtotime($search_date ." -3 days")< strtotime(date("dmY"))) print("inactive"); ?>" data-date="<?php print(date("d/m/Y",strtotime($search_date ))); ?>" data-solar-day="<?php print(date("d",strtotime($search_date ))); ?>" data-solar-month="<?php print(date("m",strtotime($search_date ))); ?>" data-solar-year="<?php print(date("Y",strtotime($search_date ))); ?>">
                                                            <span style="text-transform: uppercase"><?php print(_cassiopeia_get_day_off_week(strtotime(date("D",strtotime($search_date ))))); ?></span>
                                                            <span><b><?php print(date("d/m",strtotime($search_date ))); ?></b></span>
                                                            <span class="lunar-date-display-active" style="font-size: 75%; color: #B91E1E; display: block; text-align: center;"></span>
                                                        </div>
                                                        <div class="<?php if($search_date==date("d-m-Y",strtotime($search_date ." +1 days"))) print("active"); if(strtotime($search_date ." -3 days")< strtotime(date("dmY"))) print("inactive");?>" data-date="<?php print(date("d/m/Y",strtotime($search_date ." +1 days"))); ?>" data-solar-day="<?php print(date("d",strtotime($search_date ." +1 days"))); ?>" data-solar-month="<?php print(date("m",strtotime($search_date ." +1 days"))); ?>" data-solar-year="<?php print(date("Y",strtotime($search_date ." +1 days"))); ?>">
                                                            <span><?php print(_cassiopeia_get_day_off_week(strtotime(date("D",strtotime($search_date ." +1 days"))))); ?></span>
                                                            <span><?php print(date("d/m",strtotime($search_date ." +1 days"))); ?></span>
                                            ...
                                            <div class="filter-block flight-block-2">
                                                <div>
                                                    ...
                                                    <div data-block="departure-flight-block" data-sort="start-time" data-direction="DESC"><b>GIỜ BAY</b></div>
                                                    <div class="hidden-xs" data-block="departure-flight-block" data-sort="duration" data-direction="DESC"><b>THỜI GIAN</b></div>
                                                    <div class="hidden-xs" data-block="departure-flight-block" data-sort="end-time" data-direction="DESC"><b>GIỜ ĐÁP</b></div>
...
<!--                                                        <span class="fa fa-plane"></span>-->
                                                    ...
                                                    <div class="block-content">
                                                        <div class="block-body">
                                                            ...
                                                            <div class="<?php  if($search_return_date==date("d-m-Y",strtotime($search_return_date ))) print("active");if(strtotime($search_return_date ." -3 days")< strtotime(date("dmY"))) print("inactive"); ?>" data-date="<?php print(date("d/m/Y",strtotime($search_return_date ))); ?>">
                                                                <span style="text-transform: uppercase"><b><?php print(_cassiopeia_get_day_off_week(strtotime(date("D",strtotime($search_return_date ))))); ?></b></span>
                                                                <span><b><?php print(date("d/m",strtotime($search_return_date ))); ?></b></span>
                                                            </div>
                                            ...
                                            <div class="filter-block flight-block-2">
                                                <div>
													<label style="margin-top: 3px">Sắp xếp: </label>
                                                    <div data-block="return-flight-block" data-sort="airline" data-direction="DESC"><b>HÃNG</B></div>
                                                    <div data-block="return-flight-block" data-sort="start-time" data-direction="DESC"><b>GIỜ BAY</b></div>
                                                    <div class="hidden-xs" data-block="return-flight-block" data-sort="duration" data-direction="DESC"><b>THỜI GIAN</b></div>
                                                    <div class="hidden-xs" data-block="return-flight-block" data-sort="end-time" data-direction="DESC"><b>GIỜ ĐÁP</b></div>
                                                    <div class="active" data-block="return-flight-block" data-sort="price" data-direction="DESC"><b>GIÁ</b></div>
                                                </div>
                                            </div>
...
(function($) {
    // Đợi lunar script load xong
    $(document).ready(function() {
        // Kiểm tra xem hàm getLunarDate đã có chưa
        if (typeof getLunarDate === 'function') {
            // Tính và hiển thị ngày âm lịch cho tất cả các ngày
            $('.block-body > div[data-solar-day]').each(function() {
                var $this = $(this);
                var day = parseInt($this.attr('data-solar-day'));
                var month = parseInt($this.attr('data-solar-month'));
                var year = parseInt($this.attr('data-solar-year'));
                
                try {
                    var lunarDate = getLunarDate(day, month, year);
                    var lunarText = lunarDate.day;
                    
                    // Nếu là ngày đầu tháng hoặc ngày 1 âm lịch, hiển thị dạng "ngày/tháng"
                    // if (day == 1 || lunarDate.day == 1) {
                    //     lunarText = lunarDate.day + '/' + lunarDate.month;
                    // }
                    lunarText_active = lunarDate.day + '/' + lunarDate.month;
                    
                    // Thêm class đặc biệt cho ngày Tết
                    var lunarClass = 'lunar-date';
                    if (lunarDate.day <= 3 && lunarDate.month == 1) {
                        lunarClass = 'lunar-date-tet';
                        $this.find('.lunar-date-display').css({
                            'color': '#fff',
                            'background': '#B91E1E',
                            'padding': '2px',
                            'border-radius': '2px'
                        });
                    } else if (lunarDate.leap == 1) {
                        lunarClass = 'lunar-date-leap';
                    }
                    
                    $this.find('.lunar-date-display').text(lunarText).addClass(lunarClass);
                    $this.find('.lunar-date-display-active').text(lunarText_active).addClass(lunarClass);

                } catch(e) {
                    console.log('Error calculating lunar date:', e);
                }
            });
        } else {
