                        ...
                        <?php foreach ($tickets as $ticket): ?>
                            ...
                            <div class="logo-airline" style="width: 100%; height: max-content" align="center">
                                ...
                                if (strpos($num, 'VN') !== false) {
									...
									$image_url = "https://qtair.vn/sites/default/files/styles/style_400x80/public/". strtolower($airline->iata).".png";
									//drupal_set_message($image_url."--2");									
                                        if(strcmp($airline->iata, "VJ") == 0){
											$ticketRule .= "*****Vietjet*****<br>";
                                            $ticketRule .= "- Khi khách chọn hạng vé ECO: Hành lý 7kg xách tay.\n
                                                ...
                                                if(strcmp($airline->iata, "QH") == 0){
                                                    ...
                                                    $ticketRule .= "- Economy Saver Max/ ECONOMYSMART: 7kg xách tay : Hành lý 7kg xách tay.<br>
                                                                    *Economy Saver Max: Không áp dụng hoàn hủy đổi ngày đổi tên.<br>
                                                                    - ECONOMYSMARTFLEX: Hành lý 7kg xách tay + 20KG ký gửi\n
                    ...
                    <?php foreach ($tickets as $ticket): ?>
                        ...
                        <div class="table-responsive">
                            ...
                            ">
                                ...
                                <?php 
									$totalTicketPrice += ($ticket->FeeAdult + $ticket->TaxAdult + $adult_fee) * $booking->adt;
									endif; ?>               
                                ...
                                <?php 
									$totalTicketPrice += ($ticket->FeeChild + $ticket->TaxChild + $child_fee) * $booking->chd;
									endif; ?>
                                <?php if ($booking->inf != 0): ?>
                                    <tr>         
                                        <td style="text-align: right;padding:5px;"><?php echo $booking->inf; ?> Em bé</td>
                                ...
                                <?php 
									$totalTicketPrice += ($ticket->FeeInfant + $ticket->TaxInfant + $infant_fee) * $booking->inf;
									endif; ?>
                                ...
                                <tr>
                                    <td colspan="4" style="
                                        ...
                                        font-weight: bold;
                                        padding: 5px;
                                    ">Tổng: <?php echo number_format($totalTicketPrice, 0, ",", "."); ?> VNĐ
                                    </td>
                                </tr>
                                </tbody>
                            </table>
