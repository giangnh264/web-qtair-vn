...
?>
<div class="article-type-6">
    <div class="article-type-6-container">
        ...
        <div class="article-info">
            ...
            <div class="node-created">
                <img src="/sites/all/themes/cassiopeia_theme/img/icons/Icon-calendar.png" alt=""> <?php echo date("d/m/Y",$node->created); ?>
            </div>
            ...
            <div class="read-more">
                <?php echo(l("Đọc tiếp", 'node/'.$node->nid, array('html'=>TRUE))); ?>
            </div>
        </div>
    </div>
</div>