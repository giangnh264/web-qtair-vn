...
<!--                </div>-->
            ...
            <div class="between">
                ...
                <div><span data-index="<?php print($key); ?>" data-ListSegment='<?php echo json_encode($FlightItem->ListSegment); ?>' class="btn-view-detail" data-airline="<?php print($AirlineCode); ?>"><?php print(t("Chi tiết")); ?></span></div>
            </div>
            <div class="endpoint">
                <div>
