...
<div id="tab-3" class=" <?php if(!empty($arg[3]) && $arg[3]=="tab-3") print("in active"); if(user_has_role(5)) print("in active"); ?>">
    <div class="filter-block">
        ...
        try{
            ...
            $query->leftJoin("field_data_field_account_transaction_name","field_account_transaction_name","field_account_transaction_name.entity_id=tbl_room_booking_report.agent");
