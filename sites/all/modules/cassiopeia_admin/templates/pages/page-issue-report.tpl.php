...
<!--                    <input type="text" name="from_date" class="form-control" autocomplete="off" value="--><?php //print(date("d-m-Y",REQUEST_TIME)); ?><!--">-->
<!--                </div>-->
<!--                <div class="to-date">-->
...
<!--                </div>-->
<!--                <div class="buttons">-->
<!--                    <button class="btn btn-success btn-filter-issue-report">Lọc</button>-->
<!--                </div>-->
<!--            </div>-->
        </div>
        <?php if(user_has_role(3) || user_has_role(7)|| user_has_role(8)): ?>
            <?php
            $cassiopeia_user_dashboard_ticket_filter_form = drupal_get_form("cassiopeia_issue_report_add_form");
            if(!empty($cassiopeia_user_dashboard_ticket_filter_form)){
                echo drupal_render($cassiopeia_user_dashboard_ticket_filter_form);
            }
            ?>
