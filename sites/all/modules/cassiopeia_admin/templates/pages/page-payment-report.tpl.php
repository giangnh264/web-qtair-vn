...
<div class="page-payment-report">
    <div class="block-container">
        ...
        <div class="page-payment-report-container">           
            <div class="filter-block">
                ...
                <div class="filter-form collapse mt-0" id="filter-form">
                    <div class="tran_kind">
            ...
            <div class="add-block active">
                ...
                <div class="add-form collapse" id="add-form" >
                    ...
                    <button class="btn btn-danger btn-excel-export btn-export ml-auto">
                        <span class="icon fa fa-file-excel-o" aria-hidden="true"></span>
                        Xuất Excel
                    </button>
                </div>
                <?php endif; ?>
