...
?>
<div class="user-manager-customer-delete">
    <div class="qt-user-title mb-3">
        <h2 class="heading caption text-uppercase clr-dark">
            Bạn có chắc chắn muốn xóa khách hàng <?php echo $customer->name; ?>
        </h2>
    </div>
    <?php
    $cassiopeia_user_customer_form = drupal_get_form("cassiopeia_user_customer_delete_form",$customer);
